...
public class Program {
	...
	private static void Z6() {
	     ...
	     String sign = "";
	     String even = v%2==0 ? "четное" : "нечетное";
	     
	     if (v < 0) sign = "отрицательное ";
	     else if (v > 0) sign = "положительное ";
	     else {
	    	 sign = "нулевое";
	    	 even = "";
	     }
	...
	private static void Z7() {
	     ...
	     map.put("905", "ћосква: 41.5");
	     map.put("194", "–остов: 19.8");
